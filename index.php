...
<head>
    ...
    <style>
        ...
        /* Color base de sugerencias usado para botones y ahora para el header */
        .btn-nav-custom { 
        ...
        /* HEADER MEJORADO CON EL COLOR DE SUGERENCIAS */
        .header-dashboard { 
            background: linear-gradient(135deg, var(--azul-solidario) 0%, var(--verde-solidario) 100%); 
        ...
        /* Logo mejorado con mayor resalte */
    ...
    <div class="main-content">
        <?php if(isset($_GET['status']) && $_GET['status'] == 'success'): ?>
            <div class="alert alert-success alert-dismissible fade show container mt-4 shadow-sm border-0" role="alert" style="border-radius: 15px;">
                <i class="fas fa-check-circle me-2"></i> <strong>¡Enviado con éxito!</strong> La sugerencia ya está en la base de datos.
    ...
    <footer class="footer-solidario">
        <div class="container text-center">
            <div class="footer-logo mb-2">
                <i class="fas fa-heart text-danger me-2"></i>Red Solidaria
            </div>
            <p class="text-muted mb-0">© 2026 Desarrollado por <strong>William Morales</strong> | ADSO</p>
            <div class="tech-stack">
                <div class="tech-item"><i class="fab fa-php"></i> PHP Base</div>
                <div class="tech-item"><i class="fas fa-database"></i> SQL Server</div>
                <div class="tech-item"><i class="fas fa-cloud"></i> InfinityFree</div>
                <div class="tech-item">@RedSolidaria</div>
            </div>
        </div>
    </footer>

    <!-- MODAL DIRECTO A LOGICA -->
                ...
                <div class="modal-body p-4">
                    <form action="controlador_/logica.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control" placeholder="Ej: William Morales" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="detalles" class="form-control" rows="4" placeholder="Escribe tu mensaje aquí..." required></textarea>
                        </div>
                        <div class="d-grid">
