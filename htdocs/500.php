...
<body>
    <div class="container d-flex justify-content-center">
        <div class="col-md-6 error-container">
            <!-- 1. Para el Logo: sube un nivel para salir de 'controlador_' -->
            <img src="../Logo.jpeg" alt="Logo" height="80" class="mb-4">

            <div class="error-code">500</div>
            <h2 class="fw-bold">¡Ups! Error Interno del Servidor </h2>
            <p class="text-muted mb-4">Lo sentimos, no pudimos procesar tu solicitud en este momento.</p>

            <!-- 2. Para el Botón: sube un nivel para llegar al index principal -->
